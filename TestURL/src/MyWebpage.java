...
//            System.out.println(content.toString());
            ...
            int endIdx;String holder="";
            while(temp.length()>holder.length()&&temp.indexOf("<a href=")!=-1) {
...
//                System.out.println(holder.substring(holder.indexOf("<a href=")+9,holder.indexOf("\"",holder.indexOf("<a href=\"")+9)));
            ...
            try {
            	...
            	System.out.println();
            	System.out.println();
            	while(temp.length()>holder.length()&&temp.indexOf("<p>")!=-1) {
